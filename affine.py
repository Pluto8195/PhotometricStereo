...
pts2 = [ pts1[0], [ pts1[0,0], pts1[2,1] ], pts1[2] ]
pts2 = np.float32(pts2)
print(pts2)


M = cv2.getAffineTransform(pts1,pts2)
dst = cv2.warpAffine(imgold,M,(width,height))
...
i1 = cv2.warpAffine(i1 ,M,(width,height))
i2 = cv2.warpAffine(i2 ,M,(width,height))
i3 = cv2.warpAffine(i3 ,M,(width,height))
